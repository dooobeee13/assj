...
/* $(function(){
	...
	$('.innercontainer').append("<div class='items'><p>첫번째 요소</p><img src='<c:url value='/icon/adminMain.jpg'/>'><img src='<c:url value='/icon/adminMain.jpg'/>'></div>");
	$('.innercontainer').append("<div class='items'>두번째 요소</div>");
	$('.innercontainer').append("<div class='items'>세번째 요소</div>");
	
	$('.innercontainer').append("<div class='items'>첫번째 요소</div>");
	$('.innercontainer').append("<div class='items'>두번째 요소</div>");
	$('.innercontainer').append("<div class='items'>세번째 요소</div>");
	...
	$.ajax({
		...
		success:function(data){
			...
			$.each(data, function(idx, items){
				...
				"</div><img src='<c:url value='/imageTest/"+this.NEWS_URL+"'/>' style='width:100%'></div>";
...
<div style="margin:0 auto; width:900px;">
	...
	<div class="row">
	 ...
	 <div class="column line-3">
	   ...
	   <%--  <div class="col-y"><div class="col-title">내 여친으로 키웟으면</div><img src="<c:url value='/imageTest/ead9ab2d1820981da4208a868f04c3b4715c84df.jpg'/>" style="width:100%"></div> --%>
	  </div>
</div>
