...
<!-- /사이드바 -->
		...
		<form role="form" class="form-inline" method="post" action="<c:url value='/member/menu/noticeEdit.do'/>">	
			...
			<div class="form-group">
				...
				<textarea class="form-control" rows="15" cols="75" id="contents" name="contents"><c:if test="${!empty map.CONTENTS}">${map.CONTENTS}</c:if></textarea>
			</div>
			<br>
			<br>
			<div id="btnDiv">
				<button type="submit" class="btn btn-default btn-sm" id="editBtn">수정</button>&nbsp;
