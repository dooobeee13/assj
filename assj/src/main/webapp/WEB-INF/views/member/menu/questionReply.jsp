	...
	<article class="col-div-100-80" style="border-left: 1px solid #b8b8b8; height:92%; overflow-y: hidden; position: relative; overflow-x: hidden;">
		...
		<div class="col-div-80-100" style="margin-left:1em; width:83%; font-size:0.7em;">
			<div class="col-div-100-20">	
				<div class="container">
					<fieldset>
		<form role="form" class="form-inline" method="post" action="<c:url value='/member/menu/questionReply.do'/>">	 
			<h1>이메일 문의 답변</h1>
			<hr>
			...
			<div class="form-group">
				...
				<textarea class="form-control" rows="7" cols="75" id="content" name="content" readonly="readonly">${vo.content}</textarea>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			</div>
			<div>
				<input type="hidden" name="adminNo" value="1">
				<input type="hidden" name="groupNo" value="${vo.no}">
			</div>
			<div class="form-group">
				<label for="replyContent">답변</label>&nbsp;&nbsp;  
				<textarea class="form-control" rows="7" cols="75" id="replyContent" name="replyContent"></textarea>
			</div>
			<br>
			<br>
			<div id="btnDiv">
				<button type="submit" class="btn btn-default btn-sm" style="background-color:#607D8B;color:#ffff" id="replyBtn">답변</button>&nbsp;
