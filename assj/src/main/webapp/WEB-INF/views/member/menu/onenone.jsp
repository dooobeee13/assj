				...
				<form role="form" class="form-inline">
					<table class="table table-bordered">
						...
						<tr>
							...
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="이력서 문의"> 이력서 문의
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="입사지원 문의"> 입사지원 문의
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="검색 문의"> 검색 문의
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="신고(불량기업/공고 등)"> 신고(불량기업/공고 등)
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="회원가입/탈퇴/ID/PW"> 회원가입/탈퇴/ID/PW
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="공고 문의"> 공고 문의
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="지원자관리 문의"> 지원자관리 문의
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="이메일/알림 문의"> 이메일/알림 문의
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="결제/유료 상품 문의"> 결제/유료 상품 문의
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="제안사항"> 제안사항
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="연봉정보 수정요청"> 연봉정보 수정요청
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="SIAT 인적성검사 문의"> SIAT 인적성검사 문의
							</label>
							<label class="radio-inline">
							<input type="radio" name="optionsRadios" id="optionsRadios1" value="기타"> 기타
							</label>
							</td>
						</tr>
						<tr>
