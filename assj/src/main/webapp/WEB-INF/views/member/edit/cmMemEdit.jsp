				...
				<form role="form" class="form-inline" method="post"
					...
					<div id="cmMemEdit">
						...
						<fieldset>
							...
							<input type="hidden" name="csNo" id="csNo" value="${vo.csNo}">
							<br>
							<br>
							<h4>
								<b>인사담당자 정보</b>
							...
							<table class="table">
								...
								<tr>
									...
									<td><input type="text" class="form-control"
										placeholder="우편번호" size="10" value="${vo.cmZipcode}" id="cmZipcode" name="cmZipcode"> 
										<input type="button" class="form-control" value="우편번호 검색"  onclick="sample4_execDaumPostcode()"> 
										<input type="text" class="form-control" placeholder="주소" size="38" id="cmAddr" value="${vo.cmAddr}" name="cmAddr"> 
										<input type="text" class="form-control" placeholder="상세주소" size="38" value="${vo.cmDetailAddr}" id="cmDetailAddr" name="cmDetailAddr"></td>
